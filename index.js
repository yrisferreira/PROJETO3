...
console.log( JOGO DA VELHA O Jogador 1 jogará com X e o Jogador 2 com O); prompt("Vamos começar? Aperte ENTER para jogar!");

let nomes = nomeJogador();

let arrTTT = [ ["0:0", "0:1", "0:2"], ["1:0", "1:1", "1:2"], ["2:0", "2:1", "2:2"] ];

let controleGeral = true; jogo(controleGeral, nomes, arrTTT);

function jogo(controle, nomeJogador, array){ let controleTurno = 0; while (controle) { let rodadas let verificador = true;
